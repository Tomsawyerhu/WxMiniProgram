...
Page({
  ...
  onLoad: function (options) {
    //监听页数的变化，更新page中内容
    getApp().setWatcher(this.data,this.watchPageNum);
    var charpter=options.charpter?options.charpter:0
    //this.requestPages(charpter)
    //初始化为每一章节的第一页
    //this.setData({
      //currentpage:this.data.pages[0]
   // })
  },
  ...
  watchPageNum:function(){
    this.setData({
      currentpage:this.data.pages[this.data.pagenum]
    })
  }
